...
Class WPHRM extends WPHRMConfig {
    ...
    function __construct() {
        ...
        add_filter( 'get_avatar' , array($this, 'new_default_avatar' ), 15, 5 );
    }
...
<?php
    ...
    public function WPHRMEmployeePromotion() {
        $result = array();
        $promotion_key = isset( $_REQUEST['promotion_key'] ) ? $_REQUEST['promotion_key'] : '';

        if( empty( $promotion_key ) ) {
            $wphrmEmployeeId = intval($_POST['wphrm_emp_promotion_id']);
            $info_type = empty($_POST['info_type']) ? 'personal_info' : sanitize_text_field($_POST['info_type']);

            $wphrm_employee_promotion = array( $_POST['wphrm_employee_promotion_date'] => array (
                'wphrm_employee_initial_level' => sanitize_text_field($_POST['wphrm_employee_initial_level']),
                'wphrm_employee_promotion_level' => sanitize_text_field($_POST['wphrm_employee_promotion_level']),
                'wphrm_employee_promotion_date' => $_POST['wphrm_employee_promotion_date']
            ));
            ...
            if (!empty($wphrmEmployeeId)) { //update
                ...
                if($info_type == 'work_info'){
                    $wphrmFormDetails['wphrm_employee_promotion'][] = $wphrm_employee_promotion;
                }
            }
            $wphrmFormDetailsData = base64_encode(serialize($wphrmFormDetails));
            if( update_user_meta($wphrmEmployeeId, "wphrmEmployeeInfo", $wphrmFormDetailsData) ) {
                $result['success'] = true;
            } else {
                $result['success'] = false;
            }
        } else {
            $wphrmEmployeeId = intval($_REQUEST['wphrm_emp_promotion_id']);
            $master_key = isset( $_REQUEST['master_key'] ) ? $_REQUEST['master_key'] : '';
            if( !empty( $promotion_key ) ) {
                $wphrmFormDetails = array();
                $wphrmFormDetails = $this->WPHRMGetUserDatas($wphrmEmployeeId, 'wphrmEmployeeInfo');
                unset( $wphrmFormDetails['wphrm_employee_promotion'][$master_key]["$promotion_key"] );
                $wphrmFormDetails['wphrm_employee_promotion'] = $wphrmFormDetails['wphrm_employee_promotion'];
                $wphrmFormDetailsData = base64_encode(serialize($wphrmFormDetails));
                if( update_user_meta($wphrmEmployeeId, "wphrmEmployeeInfo", $wphrmFormDetailsData) ) {
                    $result['success'] = true;
                } else {
    ...
    public function WPHRMEmployeeBasicInfo() {
        ...
        $wphrm_hidden_employee_designation = '';
        ...
        $wphrm_employee_educational_level = '';
        $wphrm_employee_ord = '';
        $wphrm_ord_start_date = '';
        $wphrm_ord_end_date = '';
        $wphrm_employee_rod = '';
        $wphrm_rod_end_date = '';
        $Employeerole = '';
        ...
        if (isset($_POST['wphrm_hidden_employee_designation']) && $_POST['wphrm_hidden_employee_designation'] != '') {
            $wphrm_hidden_employee_designation = sanitize_text_field($_POST['wphrm_hidden_employee_designation']);
        }
        ...
        if (isset($_POST['wphrm_employee_educational_level']) && $_POST['wphrm_employee_educational_level'] != '') {
            $wphrm_employee_educational_level = sanitize_text_field($_POST['wphrm_employee_educational_level']);
        }
        if (isset($_POST['wphrm_employee_ord']) && $_POST['wphrm_employee_ord'] != '') {
            $wphrm_employee_ord = sanitize_text_field($_POST['wphrm_employee_ord']);
        }
        if (isset($_POST['wphrm_rod_end_date']) && $_POST['wphrm_rod_end_date'] != '') {
            $wphrm_rod_end_date = sanitize_text_field($_POST['wphrm_rod_end_date']);
        }
        if (isset($_POST['wphrm_ord_start_date']) && $_POST['wphrm_ord_start_date'] != '') {
            $wphrm_ord_start_date = sanitize_text_field($_POST['wphrm_ord_start_date']);
        }
        if (isset($_POST['wphrm_ord_end_date']) && $_POST['wphrm_ord_end_date'] != '') {
            $wphrm_ord_end_date = sanitize_text_field($_POST['wphrm_ord_end_date']);
        }
        if (isset($_POST['wphrm_employee_rod']) && $_POST['wphrm_employee_rod'] != '') {
            $wphrm_employee_rod = sanitize_text_field($_POST['wphrm_employee_rod']);
        }
        ...
        $wphrm_employee_has_child = '';
        if (isset($_POST['wphrm_employee_has_child']) && $_POST['wphrm_employee_has_child'] != '') {
            $wphrm_employee_has_child = sanitize_text_field($_POST['wphrm_employee_has_child']);
        }
        ...
        $wphrm_employee_passport_issued = '';
        if (isset($_POST['wphrm_employee_passport_issued']) && $_POST['wphrm_employee_passport_issued'] != '') {
            $wphrm_employee_passport_issued = sanitize_text_field($_POST['wphrm_employee_passport_issued']);
        }
        $wphrm_employee_passport_expiration = '';
        if (isset($_POST['wphrm_employee_passport_expiration']) && $_POST['wphrm_employee_passport_expiration'] != '') {
            $wphrm_employee_passport_expiration = sanitize_text_field($_POST['wphrm_employee_passport_expiration']);
        }
        $wphrm_employee_race = '';
        ...
        $wphrm_employee_maternity_carried = array();
        if( isset($_POST['wphrm_employee_maternity_carried']) ){
            $wphrm_employee_maternity_carried = $_POST['wphrm_employee_maternity_carried'];
        }
        $wphrm_employee_medical_reimbursement = array();
        if( isset($_POST['wphrm_employee_medical_reimbursement']) ){
            $wphrm_employee_medical_reimbursement = $_POST['wphrm_employee_medical_reimbursement'];
        }
        ...
        if (!empty($wphrmEmployeeId)) { //update
            ...
            if($info_type == 'work_info'){
                ...
                $wphrmFormDetails['wphrm_hidden_employee_designation'] = $wphrm_hidden_employee_designation;
                ...
                if(!empty($wphrm_employee_maternity_carried)){
                    $wphrmFormDetails['wphrm_employee_maternity_carried'] = $wphrm_employee_maternity_carried;
                }
                if(!empty($wphrm_employee_medical_reimbursement)){
                    $wphrmFormDetails['wphrm_employee_medical_reimbursement'] = $wphrm_employee_medical_reimbursement;
                }
                ...
                $wphrmFormDetails['wphrm_employee_educational_level'] = $wphrm_employee_educational_level;
                $wphrmFormDetails['wphrm_employee_ord'] = $wphrm_employee_ord;
                $wphrmFormDetails['wphrm_ord_start_date'] = $wphrm_ord_start_date;
                $wphrmFormDetails['wphrm_ord_end_date'] = $wphrm_ord_end_date;
                $wphrmFormDetails['wphrm_employee_rod'] = $wphrm_employee_rod;
                $wphrmFormDetails['wphrm_rod_end_date'] = $wphrm_rod_end_date;
                ...
                $wphrmFormDetails['wphrm_employee_passport_issued'] = $wphrm_employee_passport_issued;
                $wphrmFormDetails['wphrm_employee_passport_expiration'] = $wphrm_employee_passport_expiration;
                $wphrmFormDetails['wphrm_employee_race'] = $wphrm_employee_race;
                $wphrmFormDetails['wphrm_employee_mstatus'] = $wphrm_employee_mstatus;
                $wphrmFormDetails['wphrm_employee_has_child'] = $wphrm_employee_has_child;
    ...
    public function WPHRMEmployeeFamilyInfo() {
        ...
        $emergency['emergency-address'] = ($_POST['emergency-address']);
        $emergency['emergency-number'] = ($_POST['emergency-number']);
        $emergency['emergency-alt-number'] = ($_POST['emergency-alt-number']);

        $emergency['emergency-name-2'] = ($_POST['emergency-name-2']);
        $emergency['emergency-relations-2'] = ($_POST['emergency-relations-2']);
        $emergency['emergency-address-2'] = ($_POST['emergency-address-2']);
        $emergency['emergency-number-2'] = ($_POST['emergency-number-2']);
        $emergency['emergency-alt-number-2'] = ($_POST['emergency-alt-number-2']);
    ...
    * */
    ...
    public function WPHRMEmployeeAttendanceData() {
        ...
        $employeeHolidayResult = $employeeAttendanceResult = $employeeLeaveResultSupervisor = $employeeLeaveResultManager = array();
        ...
        if (isset($employee_id) && !empty($employee_id)) {
            ...
            $wphrmEmployeeBasicInfo = (object)$this->WPHRMGetUserDatas( $employee_id, 'wphrmEmployeeInfo' );
            $emp_level = $wphrmEmployeeBasicInfo->wphrm_employee_level;
            if( $emp_level == 'senior_manager' ) {
                $users = $this->WPHRMGetAllEmployees();
                foreach($users as $user ) {
                    if( !in_array('administrator', $user->roles ) ) {
                        $employeeBasicInfo = (object)$this->WPHRMGetUserDatas( $user->ID, 'wphrmEmployeeInfo' );
                        if( $user->ID != $employee_id ) {
                            $emp_attendance = $wpdb->get_results("SELECT * from $this->WphrmAttendanceTable WHERE `employeeID` = $user->ID AND (`date` <= '$holiday_dates' or leaveApplicationId <> 0) ");
                            if( $emp_attendance ) {
                                foreach ($emp_attendance as $emp_attendancekey => $emp_attendances) {
                                    //Check if this day leave
                                    $emp_leave_status = '';
                                    if($emp_attendances->leaveApplicationId){
                                        $emp_leave_status = $this->get_leave_application_info($emp_attendances->leaveApplicationId, 'applicationStatus');
                                    }

                                    $leaves_date = $wpdb->get_results( "SELECT * FROM $this->WphrmLeaveApplicationTable WHERE employeeID = $user->ID" );
                                    foreach ($leaves_date as $leavedate) {
                                        $leave_date = $leavedate->date;
                                    }
                                    
                                    if ($emp_attendances->status == 'absent' && $emp_leave_status == 'approved') {
                                        $title = $employeeBasicInfo->wphrm_employee_fname.' '.$employeeBasicInfo->wphrm_employee_fname.' - On Leave';
                                        $background = 'yellow';
                                        $textColor = '#000';
                                    }
                                    if ($emp_attendances->halfDayType == 'halfday') {
                                        $title =  $employeeBasicInfo->wphrm_employee_fname.' '.$employeeBasicInfo->wphrm_employee_fname.' - Half day ';
                                        $background = 'yellow';
                                        $textColor = '#000';
                                    }
                                    if ($emp_attendances->halfDayType == 'halfday' && $emp_leave_status == 'approved') {
                                        $title =  $employeeBasicInfo->wphrm_employee_fname.' '.$employeeBasicInfo->wphrm_employee_fname.' - Half day (Leave)';
                                        $background = 'yellow';
                                        $textColor = '#000';
                                    }
                                    $employeeLeaveResultSupervisor[] = array(
                                        'title' => '' . $title . '',
                                        'start' => '' . $emp_attendances->date . '',
            ...
            } elseif( $emp_level == 'manager' ) {
                $users = $this->WPHRMGetAllEmployees();
                foreach($users as $user ) {
                    if( !in_array('administrator', $user->roles ) ) {
                        $employeeBasicInfo = (object)$this->WPHRMGetUserDatas( $user->ID, 'wphrmEmployeeInfo' );
                        if( $employeeBasicInfo->wphrm_employee_department == $wphrmEmployeeBasicInfo->wphrm_employee_department && $user->ID != $employee_id ) {
                            $emp_attendance = $wpdb->get_results("SELECT * from $this->WphrmAttendanceTable WHERE `employeeID` = $user->ID AND (`date` <= '$holiday_dates' or leaveApplicationId <> 0) ");
                            if( $emp_attendance ) {
                                foreach ($emp_attendance as $emp_attendancekey => $emp_attendances) {
                                    //Check if this day leave
            ...
            } elseif( $emp_level == 'supervisor' ) {
                $users = $this->WPHRMGetAllEmployees();
                foreach($users as $user ) {
                    if( !in_array('administrator', $user->roles ) ) {
                        $employeeBasicInfo = (object)$this->WPHRMGetUserDatas( $user->ID, 'wphrmEmployeeInfo' );
                        if( $employeeBasicInfo->wphrm_employee_level == 'staff' && $employeeBasicInfo->wphrm_employee_department == $wphrmEmployeeBasicInfo->wphrm_employee_department && $user->ID != $employee_id ) {
                            $emp_attendance = $wpdb->get_results("SELECT * from $this->WphrmAttendanceTable WHERE `employeeID` = $user->ID AND (`date` <= '$holiday_dates' or leaveApplicationId <> 0) ");
                            if( $emp_attendance ) {
                                foreach ($emp_attendance as $emp_attendancekey => $emp_attendances) {
                                    //Check if this day leave
            ...
            foreach ($employee_attendance as $employee_attendancekey => $employee_attendances) {
                ...
                if ($employee_attendances->status == 'absent' && $leave_status == 'approved' || $employee_attendances->status == 'present' && $leave_status == 'approved') {
                    $title = 'On Leave';
                    $background = 'red';
                    $textColor = '#fff';
                }
            ...
            foreach ($employee_holidays as $employee_holidaykey => $employee_holiday) {
                if( $employee_holiday->wphrmOccassion == 'Saturday' || $employee_holiday->wphrmOccassion == 'Sunday' ) {
                    $employeeHolidayResult[] = array('title' => '',
            ...
            foreach ($employee_attendance as $employee_attendances) {
                ...
                $employee_attendanceLeave = $wpdb->get_results("select count(id) as mydataLeave  from $this->WphrmAttendanceTable where  `date` = '$employee_attendances->date' AND status ='absent' AND applicationStatus='approved'");
                ...
                if (in_array('absent', $present)) {
                    $employeeAttendanceResult[] = array('title' => 'On Leave - ' . $employee_attendanceLeave[0]->mydataLeave,
                                                        'start' => '' . $employee_attendances->date . '',
                                                        'backgroundColor' => '#ff9933',
                                                        'url' => '?page=wphrm-employee-absent&condition=present&date=' . $employee_attendances->date
                                                       );
                } else {
                    $employeeAttendanceResult[] = array('title' => 'On Leave - 0',
                                                        'start' => '' . $employee_attendances->date . '',
                                                        'backgroundColor' => '#ff9933',
                                                       );
                }
        ...
        $my_attendance = array_merge( $employeeAttendanceResult, $employeeHolidayResult, $employeeLeaveResultSupervisor, $employeeLeaveResultManager );
    ...
    public function WPHRMUserLeaveApplicationsInfo() {
        ...
        if( $_POST['wphrm_leavetype'] == 62 || $_POST['wphrm_leavetype'] == 37 || $_POST['wphrm_leavetype'] == 38 || $_POST['wphrm_leavetype'] == 39 || $_POST['wphrm_leavetype'] == 63 || $_POST['wphrm_leavetype'] == 64 || $_POST['wphrm_leavetype'] == 41 || $_POST['wphrm_leavetype'] == 42 || $_POST['wphrm_leavetype'] == 43 ) {
        ...
        if ($_POST['maternity-option'] != '') {
            $maternityOption = esc_sql($_POST['maternity-option']); // esc
        }
        ...
        if (!empty($userLeaveApplications)) {
            $wpdb->update(
                ...
                array(
                    ...
                    'maternity_option' => $maternityOption,
            ...
            if (empty($appliedDate)) {
                ...
                $id = $wpdb->insert(
                    ...
                    array(
                        ...
                        'maternity_option' => sanitize_text_field($maternityOption),
    ...
    public function WPHRMCheckHolidayBetweenDate() {
        ...
        if( $leave_id == 35 ) {
            ...
            $max_leave = $this->get_employee_total_leave($employee_id, $leave_id);
        ...
        } elseif( $leave_id == 45 || $leave_id == 48 || $leave_id == 49 || $leave_id == 50 ) {
            $leave_type = $this->get_leave_info($leave_id);
            ...
            if( $expiry > $date_today ) {
                $max_leave = $wphrm_employee_maternity_carried[$ytoday]['count'] + $max_leave;
            } else {
                $max_leave = $max_leave;
            }
            ...
            $message['total_leave_left'] = $max_leave - $used_leave;
            $message['max_leave_html'] = $used_leave.'/'.$max_leave;
        } elseif( $leave_id == 39 || $leave_id == 41 || $leave_id == 42 || $leave_id == 43 ) {
            $leave_type = $this->get_leave_info($leave_id);
            if( $leave_id == 39 ) {
        ...
        if( $leave_id == 37 || $leave_id == 38 || $leave_id == 39 || $leave_id == 41 || $leave_id == 42 || $leave_id == 43 || $leave_id == 63 || $leave_id == 64 ) {
            $message['medical_claim'] = true;
            $wphrmEmployeeInfo = $wphrm->WPHRMGetUserDatas($employee_id, 'wphrmEmployeeInfo');
            ...
            $message['claimed_medical'] = $wphrm_claimed_medical[$yearToday]['amount'] + $claimed;
            $message['reimbursement'] = $reimbursement - $message['claimed_medical'];
        } else {
            $message['medical_claim'] = false;
        }
                
        $message['success'] = true;
        $message['holiday'] = $hday;
        $message['leave'] = $lday;
        $message['max_leave'] = $max_leave;
    ...
    function get_simplex_countries(){
        return array('SG', 'CN', 'MY', 'MN', 'MM', 'VN');
    }

    function get_nationality_list() {
        $nationalities = array( 'Afghan', 'Albanian', 'Algerian', 'American', 'Andorran', 'Angolan', 'Antiguan and Barbudan', 'Argentine', 'Armenians', 'Aruban', 'Australian', 'Austrian', 'Azerbaijanis', 'Bahamian', 'Bahraini', 'Bangladeshi', 'Barbadian', 'Basque', 'Belarusian', 'Belgian', 'Belizean', 'Beninese', 'Bermudian', 'Bhutanese', 'Bolivians', 'Bosniak', 'Bosnian and Herzegovinian', 'Botswana', 'Brazilian', 'Breton', 'British', 'British Virgin Islander', 'Bruneian', 'Bulgarian', 'Burkinabe', 'Burmese', 'Burundian', 'Cambodian', 'Cameroonian', 'Canadian', 'Catalans', 'Cape Verdean', 'Chadian', 'Chilean', 'Chinese', 'Columbian', 'Comorian', 'Congolese', 'Costa Rican', 'Croatian', 'Cuban', 'Cypriot', 'Czech', 'Danes', 'Djiboutian', 'Dominican(Commonwealth)', 'Dominican(Republic)', 'Dutch', 'East Timorese', 'Ecuadorian', 'Egyptian', 'Emirati', 'English', 'Equatoguinean', 'Eritrean', 'Estonian', 'Ethiopian', 'Falkland Islander', 'Faroese', 'Fijian', 'Finn', 'Finnish Swedish', 'Filipino', 'French Citizen', 'Gabonese', 'Gambians', 'German', 'Ghanaian', 'Gibraltarian', 'Greek', 'Grenadian', 'Guatemalan', 'Guianese', 'Guinea-Bissau National', 'Guyanese', 'Haitian', 'Honduran', 'Hong Konger', 'Hungarian', 'Icelander', 'I-Kiribati', 'Indian', 'Indonesian', 'Iranian', 'Iraqi', 'Irish', 'Israeli', 'Italian', 'Ivoirian', 'Jamaican', 'Japanese', 'Jordanian', 'Kazakh', 'Kenyan', 'Korean', 'Kosovar', 'Kuwaitis', 'Kyrgyz', 'Lao', 'Latvian', 'Lebanese', 'Liberian', 'Libyan', 'Liechtensteiner', 'Lithuanian', 'Luxembourger', 'Macao', 'Macedonian', 'Malagasy', 'Malawian', 'Malaysian', 'Maldivian', 'Malian', 'Maltese', 'Manx', 'Marshallese', 'Mauritanian', 'Mauritian', 'Mexican', 'Micronesian', 'Moldovan', 'Monegasque', 'Mongolian', 'Montenegrin', 'Moroccan', 'Mozambican', 'Namibian', 'Nauran', 'Nepalese', 'New Zealander', 'Nicaraguan', 'Nigerien', 'Nigerian', 'Norwegian', 'Omani', 'Pakistani', 'Palauan', 'Palestinian', 'Panamanian', 'Papua New Guinean', 'Paraguayan', 'Peruvian', 'Poles', 'Portuguese', 'Puerto Rican', 'Qatari', 'Quebecer', 'Reunionnai', 'Romanian', 'Russian', 'Rwandan', 'Saint Kitts and Nevis', 'Saint Lucian', 'Salvadoran', 'Sammarinese', 'Samoan', 'Sao Tome and Principe', 'Saudi', 'Scot', 'Senegalese', 'Serb', 'Seychelloi', 'Sierra Leoneans', 'Singaporean', 'Slovak', 'Slovene', 'Solomon Islander', 'Somali', 'Somalilander', 'Sotho', 'South African', 'Spaniard', 'Sri Lankan', 'Sudanese', 'Surinamese', 'Swazi', 'Swede', 'Swiss', 'Syriac', 'Syrian', 'Taiwanese', 'Tajik', 'Tanzanian', 'Thai', 'Tibetan', 'Tobagonian', 'Togolese', 'Tongan', 'Trinidadian', 'Tunisian', 'Turk', 'Tuvaluan', 'Ugandan', 'Ukrainian', 'Uruguayan', 'Uzbek', 'Vanuatuan', 'Venezuelan', 'Vietnamese', 'Vincentian', 'Welsh', 'Yemeni', 'Zambian', 'Zimbabwean' );
    ...
    function get_employee_max_leave( $user_id, $leave_rule, $leave_type = null, $year = null ) {
        ...
        if( $leave_type->id == 35 ) {
            $cp = count( $wphrmEmployeeInfo['wphrm_employee_promotion'] );
            $pdate = $wphrmEmployeeInfo['wphrm_employee_promotion'][$cp-1];
            if( !empty( $pdate ) ) {
                foreach ($pdate as $key => $pd) {
                    $promotion_date = explode( '-', $pd['wphrm_employee_promotion_date'] );
                    if( $promotion_date[2] == date('Y') ) {
                        $join_date = date( 'm/d/Y', strtotime( $emp->basic_info->wphrm_employee_joining_date . ' +1 day'));
                        $wphrmEmployeeJoiningDate = new DateTime( $join_date );
                        $today = new DateTime();
                        $interval = $today->diff( $wphrmEmployeeJoiningDate );
                        $wphrmEmployeeJoiningToCurrentTotalYear = ( (int) $interval->format('%y years') + 1 );
                        $leave_entitlement_count = $wpdb->get_var( "SELECT COUNT(*) FROM  $this->WphrmEmployeeLevelTable WHERE years_of_service = $wphrmEmployeeJoiningToCurrentTotalYear" );
                        ...
                        if(
                            ...
                            $pro_leave = ( $pro_leave + $annual_leave_history[$year-1]['count'] );
                        }
                        $previous = ( $leave_entitlement->$pd['wphrm_employee_initial_level']/12 ) * ( $promotion_date[1] - 1 );
                        ...
                        $new_leave = round( (float)$previous + (float)$next );

                        //$total = ( (float)$new_leave + (float)$pro_leave );
                        $total = ( $leave_entitlement->$pd['wphrm_employee_initial_level']/12 );
                    } else {
                        ...
                        $pro_leave = $leave_entitlement->$pd['wphrm_employee_promotion_level'];
    ...
    function calculate_unused_annual_leave(){
        ...
        $max_leave = $this->get_employee_max_leave($user_id, $leave_info->leave_rules, $leave_info, $year);
        //$max_leave = $this->get_employee_total_leave($user_id, 35);
        //$used = isset($data['leaves'][$annual_leave_id]) ? count($data['leaves'][$annual_leave_id]) : 0 ;
        $used = $this->get_used_leave($user_id, 35, $year);
        echo $year."\n";
    ...
    function get_used_leave($user_id, $leave_id, $year = null, $month_start = null, $month_end = null){
        ...
        foreach($employee_leaves as $leave){
            ...
            $employee_holidays = $wpdb->get_var("SELECT COUNT(*) FROM $this->WphrmHolidaysTable WHERE wphrmDate BETWEEN '$leave->date' AND '$leave->toDate'");

            //count the number of days of their leave
            $this_leave_count = $leave_internvel->d - $employee_holidays;
    ...
    function WPHRMBulkDeleteHoliday() {
        global $wpdb;
        $response = array();
        $toDelete = empty( $_REQUEST['to_delete_holiday_per_year'] ) ? array() : $_REQUEST['to_delete_holiday_per_year'];
        $ids = explode( ',', $toDelete );
        foreach( $toDelete as $id ) {
            $result = $wpdb->query("DELETE FROM `$this->WphrmHolidaysTable` WHERE `id`= $id");
        }
        if( $result ) {
            $response['success'] = true;
        } else {
        ...
        $response['to_delete'] = $toDelete;
        echo json_encode($response);
        exit;
    }

    function new_default_avatar ( $avatar, $id_or_email, $size, $default, $alt ) {
        global $current_user;
        $wphrmEmployeeBasicInfo = $this->WPHRMGetUserDatas( $current_user->id, 'wphrmEmployeeInfo' );
        if (isset($wphrmEmployeeBasicInfo['employee_profile']) && $wphrmEmployeeBasicInfo['employee_profile'] != '') {
            $new_avatar_url = esc_attr($wphrmEmployeeBasicInfo['employee_profile']);
        } else {
            if (isset($wphrmEmployeeBasicInfo['wphrm_employee_gender']) && $wphrmEmployeeBasicInfo['wphrm_employee_gender'] == 'Male') {
                $new_avatar_url = esc_attr(plugins_url('assets/images/default-male.jpeg', __FILE__));
            } else {
                $new_avatar_url = esc_attr(plugins_url('assets/images/default-female.jpeg', __FILE__));
            }
        }
        $avatar = 'YOUR_NEW_IMAGE_URL';
        $avatar = '<img alt="'.$alt.'" src="'.$new_avatar_url.'" class="avatar avatar-{$size} photo">';
        return $avatar;
    }
...
add_action('wp_ajax_WPHRMEmployeePromotion', array(&$wphrm, 'WPHRMEmployeePromotion'));
add_action('wp_ajax_nopriv_WPHRMEmployeePromotion', array(&$wphrm, 'WPHRMEmployeePromotion'));
/*J@F*/
...
add_action('wp_ajax_WPHRMBulkDeleteHoliday', array(&$wphrm, 'WPHRMBulkDeleteHoliday'));
/*RTY END*/
