...
(function ($, window, document) {
    ...
    SearchableOptionList.prototype = {
        ...
        defaults: {
            ...
            texts: {
                noItemsAvailable: WPHRMSol.noItemsAvailable,
                selectAll: WPHRMSol.selectAll,
                selectNone: WPHRMSol.selectNone,
                quickDelete: '&times;',
                searchplaceholder: WPHRMSol.searchplaceholder,
                loadingData: WPHRMSol.loadingData,
                itemsSelected: WPHRMSol.itemsSelected,
            },
        ...
        init: function () {
            ...
            if (!originalName) {
                this._showErrorLabel(WPTTARSol.itemsattribute);
                return;
            }
